        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label ng-repeat="key in notSorted(types)" ng-init="type = types[key]" class="radio-inline">
                            <input ng-model="data.msgType" type="radio" name="msgType" value="{{key}}"> {{type.label}}
                        </label>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div ng-if="inArray('event_key', types[data.msgType].target) >= 0" class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input ng-model="data.event_key" type="text" class="form-control" name="event_key" placeholder="菜单事件名">
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    angular.module('simulatorApp', []).controller('SimulatorController', function ($scope, $http) {
        ...
        $scope.types = <?= json_encode($this->context->types, JSON_UNESCAPED_UNICODE) ?>;
        $scope.data = {
            msgType: 'text'
        };
        $scope.history = [];
